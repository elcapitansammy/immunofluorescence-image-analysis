This is a basic analysis tool for analyzing immunofluorescent images of cells. The most important files are the restarting.py file and the speckles_count.py 
